...
class daoBaseClass:
    ...
    def __init__(self, databasepath, SQL_query=None, logf=None, _trace=0, _debug=0):
        ...
        #
        try:
            self.daoEngine = win32com.client.Dispatch("DAO.DBEngine.36")
        except:
        ...
        # ----------------------------------------------------------------------
        try:
            self.daoDB = self.daoEngine.OpenDatabase(self.path)
        except:
    ...
    def __getitem__(self, key):
        ...
        # ----------------------------------------------------------------------
        try:
            return self.daoRS.Fields(key).Value
        except:
            emsg = "Field name '%s' not found in current record" % key
            if self.logf:
                self.logf.writelines("E", emsg)
            else:
                print(emsg)
            return None
    ...
    def __setitem__(self, key, value):
        ...
        # ----------------------------------------------------------------------
        try:
            self.daoRS.Fields(key).Value = value
        except:
    ...
    def execute(self, SQL_query):
        ...
        '''
        try:
            self.daoRS = self.daoDB.OpenRecordset(SQL_query)
        except:
